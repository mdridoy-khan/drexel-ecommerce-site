...
-----------------------------------------------------------------------------------------*/
	...
	$('#mobile-menu-active').meanmenu({
		meanMenuContainer: '.mobile-menu-activation',
		meanScreenWidth: "767",
	});
/*---------------------------------------------------------------------------------------
...
-----------------------------------------------------------------------------------------*/  
	...
	function mainSlider() {
		...
		BasicSlider.slick({
			...
			fade: true,
			arrows: true,
			prevArrow:'<a href="#" class="slick-prev">Back</a>',
	...
	// single-mixed-active
	$('.first-single-mixed-active').slick({
		autoplay: true,
		infinite: true,
		slidesToShow: 1,
		slidesToScroll: 1,
	...
	// product connect slider homepage4
	 $('.product-page4-active').slick({
	  slidesToShow: 4,
	  slidesToScroll: 1,
	  fade: false,
	  arrows: true,
	  prevArrow:'<a href="#" class="slick-prev">Back</a>',
	  nextArrow:'<a href="#" class="slick-next">Next</a>',
	  asNavFor: '.product-bottmo'
	});
	$('.product-bottmo').slick({
	  slidesToShow: 4,
	  slidesToScroll: 1,
	  asNavFor: '.product-page4-active',
	  dots: false,
	  arrows: false,
	  centerMode: false,
	  focusOnSelect: false,
